...
export default function Nav() {
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between gap-4 border-b border-horizon bg-midnight/80 px-5 py-4 backdrop-blur-md sm:px-12">
      <Link
        to="/"
        className="font-display flex items-center gap-2 text-base font-semibold tracking-[0.22em] text-neon-pink no-underline"
      >
        <span className="flex flex-col text-[0.6em] font-extrabold uppercase leading-none tracking-tight">
          <span className="text-neon-cyan">IAM</span>
